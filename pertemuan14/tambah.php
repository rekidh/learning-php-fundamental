...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <!-- enctype="multipart/form-data" untuk mengelola data dengan memisakahn jalur "STRING" yang di tangkap oleh $_POST dan file akan di kelola $_FILE -->
        <ul>
            <li>
            ...
            <li>
                ...
                <input type="file" name="gambar" id="gambar" require> <!-- tipe file ,untuk meng upload gambar -->
            </li>
            <br>
            <li>
