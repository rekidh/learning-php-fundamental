...
if (isset($_POST["submit"])) {                     // setelah di submit baru code ini akan di jalankan 
    ...
    if (edit($_POST) > 0) {                        // cek keberhasilan data dan PANGIL function edit();
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <ul>
            <!-- <input type="hidden" value=" <?php //$row["id"]
                                                ?>" >//  <=baris ini tidak perlu saya tulis karena Id sudah di
                                                                // GET di bagian atas -->
            ...
            <li>
                ...
                <img src="img/<?= $row['gambar'] ?>" alt="" width="80px" height="70px"> <br>
